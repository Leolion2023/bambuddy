export default {
  ...
  // OrcaSlicer
  orcaslicer: {
    title: 'Mit OrcaSlicer slicen',
    enabled: 'OrcaSlicer aktiviert',
    path: 'OrcaSlicer-Pfad',
    available: 'Verfügbar',
    notAvailable: 'Nicht verfügbar',
    status: {
      ready: 'OrcaSlicer ist bereit',
      disabled: 'OrcaSlicer-Integration ist deaktiviert',
      notFound: 'OrcaSlicer nicht gefunden',
      enableFirst: 'OrcaSlicer zuerst in den Einstellungen aktivieren',
    },
    jobs: {
      title: 'Slice-Aufträge',
      noJobs: 'Keine Slice-Aufträge',
      queued: 'In Warteschlange',
    ...
    profiles: {
      ...
      selectFilament: 'Filament-Profil auswählen',
      selectPrinter: 'Drucker-Profil auswählen',
      selectProcess: 'Prozess-Profil auswählen',
      optional: '(Optional)',
      noProfiles: 'Keine Profile verfügbar',
      importFirst: 'Profile zuerst in lokalen Voreinstellungen importieren',
    },
    actions: {
      slice: 'Slicen',
      slicing: 'Wird geslict...',
      startSlicing: 'Slicing starten',
      cancel: 'Abbrechen',
      download: 'Herunterladen',
      viewJobs: 'Slice-Aufträge anzeigen',
      viewInArchive: 'Im Archiv anzeigen',
    },
    settings: {
      title: 'OrcaSlicer-Einstellungen',
      enabled: 'OrcaSlicer-Integration aktivieren',
      pathLabel: 'OrcaSlicer-Pfad',
      pathPlaceholder: 'z.B. /usr/bin/orca-slicer',
      pathHelp: 'Leer lassen für automatische Erkennung',
      useExternalApi: 'Externe OrcaSlicer-API verwenden',
      useExternalApiDesc: 'Verbindung zu externem OrcaSlicer-API-Dienst statt lokalem CLI',
      apiUrlLabel: 'OrcaSlicer-API-URL',
      apiUrlPlaceholder: 'z.B. http://localhost:8080',
      apiUrlHelp: 'URL des externen OrcaSlicer-API-Dienstes',
      autoPushToArchive: 'Geslicte Dateien automatisch archivieren',
      autoPushToArchiveDesc: 'Geslicte Dateien automatisch zum Archiv hinzufügen',
      testConnection: 'OrcaSlicer testen',
      save: 'Einstellungen speichern',
    },
    messages: {
      jobCreated: 'Slice-Auftrag erstellt',
      jobCancelled: 'Slice-Auftrag abgebrochen',
      slicingComplete: 'Slicing abgeschlossen',
      slicingFailed: 'Slicing fehlgeschlagen',
      selectFile: 'Bitte Datei zum Slicen auswählen',
      pushedToArchive: 'Geslicte Datei zum Archiv hinzugefügt',
    },
    errors: {
      notEnabled: 'OrcaSlicer-Integration ist nicht aktiviert',
      notAvailable: 'OrcaSlicer ist nicht verfügbar',
      fileNotFound: 'Datei nicht gefunden',
      presetNotFound: 'Profil nicht gefunden',
      slicingFailed: 'Slicing fehlgeschlagen',
      jobNotFound: 'Slice-Auftrag nicht gefunden',
    },
  },
