export default {
  ...
  // OrcaSlicer
  orcaslicer: {
    title: 'Slice with OrcaSlicer',
    enabled: 'OrcaSlicer Enabled',
    path: 'OrcaSlicer Path',
    available: 'Available',
    notAvailable: 'Not Available',
    status: {
      ready: 'OrcaSlicer is ready',
      disabled: 'OrcaSlicer integration is disabled',
      notFound: 'OrcaSlicer executable not found',
      enableFirst: 'Enable OrcaSlicer in settings first',
    },
    jobs: {
      title: 'Slicing Jobs',
      noJobs: 'No slicing jobs',
      queued: 'Queued',
    ...
    profiles: {
      ...
      selectFilament: 'Select filament preset',
      selectPrinter: 'Select printer preset',
      selectProcess: 'Select process preset',
      optional: '(Optional)',
      noProfiles: 'No profiles available',
      importFirst: 'Import profiles in Local Presets first',
    },
    actions: {
      slice: 'Slice',
      slicing: 'Slicing...',
      ...
      cancel: 'Cancel',
      download: 'Download',
      viewJobs: 'View Slicing Jobs',
      viewInArchive: 'View in Archive',
    },
    settings: {
      title: 'OrcaSlicer Settings',
      enabled: 'Enable OrcaSlicer Integration',
      pathLabel: 'OrcaSlicer Executable Path',
      pathPlaceholder: 'e.g., /usr/bin/orca-slicer',
      pathHelp: 'Leave empty to auto-detect from PATH',
      useExternalApi: 'Use External OrcaSlicer API',
      useExternalApiDesc: 'Connect to external OrcaSlicer API service instead of using local CLI',
      apiUrlLabel: 'OrcaSlicer API URL',
      apiUrlPlaceholder: 'e.g., http://localhost:8080',
      apiUrlHelp: 'URL of the external OrcaSlicer API service',
      autoPushToArchive: 'Auto-push Sliced Files to Archive',
      autoPushToArchiveDesc: 'Automatically add sliced files to archive when slicing completes',
      testConnection: 'Test OrcaSlicer',
      save: 'Save Settings',
    },
    messages: {
      jobCreated: 'Slicing job created',
      jobCancelled: 'Slicing job cancelled',
      slicingComplete: 'Slicing completed',
      slicingFailed: 'Slicing failed',
      selectFile: 'Please select a file to slice',
      pushedToArchive: 'Sliced file added to archive',
    },
    errors: {
      notEnabled: 'OrcaSlicer integration is not enabled',
      notAvailable: 'OrcaSlicer is not available',
      fileNotFound: 'File not found',
      presetNotFound: 'Preset not found',
      slicingFailed: 'Slicing failed',
      jobNotFound: 'Slicing job not found',
    },
  },
